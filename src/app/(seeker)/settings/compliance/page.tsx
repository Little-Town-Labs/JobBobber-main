    ...
    <div className="mx-auto max-w-2xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Manage your data, account deletion, and security settings.
        </p>
      </div>
      ...
      <section data-testid="data-export-section" className="rounded-lg border p-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Download a copy of all your personal data stored in JobBobber.
        </p>
        <button
        ...
        >
          {exportMutation.isFetching ? "Exporting..." : "Export My Data"}
        </button>
      </section>
